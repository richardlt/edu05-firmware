...
void writePortB(char value){inOutModePortB(0);PORTB=value;}	
...
void lcdInit(void){    
    lcdSendConfigByte(0x33);
    lcdSendConfigByte(0x32);
    lcdSendConfigByte(0x28);
...
void EDU05Init(void){
	...
	char myString1 []= " EDU05 firmware                          open source :)"; 		
 	TRISC=0b00111000;
